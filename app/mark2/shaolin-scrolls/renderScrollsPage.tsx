          ...
          <section className="flex flex-col-reverse gap-3 md:flow-root">
            ...
            <div className="space-y-3">
              <p className="text-[16px] md:text-[18px] text-muted-foreground">
                ...
                personal projects through one release system. This has allowed
                me to bucket work into my alter egos and continue to release
                card sorting, documentation, development, storytelling, and any
                number of other things on a relatively predictable schedule.
              </p>
              <p className="text-[16px] md:text-[18px] text-muted-foreground">
                The major.minor.patch structure I landed on is flexible and
                suits my needs. By pushing my work through this structure, it
                helps me to consider when things will get done, and more
                importantly, is the work completed or not. Sometimes you need to
                close the book on an idea that is good enough and this helps me
                do just that.
              </p>
              <p className="text-[16px] md:text-[18px] text-muted-foreground">
                2026-01-10: Added the Release Type Legend to help me quickly
                find the right ID......point being, the release creation process
                needs some help. It&apos;s too annoying. Not, unlike me.
              </p>
              <p className="text-[16px] md:text-[18px] text-muted-foreground">
                Iterate.
              </p>
