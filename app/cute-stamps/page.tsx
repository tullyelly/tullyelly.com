      ...
      <article className="mx-auto max-w-3xl space-y-10 py-10">
        ...
        <section className="space-y-4">
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            As you may or may not have heard, our little lulu is getting
            married! Thankfully, I am in charge of very little up until now.
            That said, this week I was tasked with finding &quot;cute
            stamps&quot; for her save the date letters and this is the adventure
            that ensued.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            In other news, I&apos;ve also started walking to my favorite
            mailboxes around town to drop off my{" "}
            <a
            ...
            Let&apos;s strap on our trusty UW-Stevens Point backpack,
            Freak&apos;s on the shirt, and Freaks on the feet so we can get on
            our merry way.
          </p>
        ...
        <section className="space-y-4">
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            ...
            talking to dad earlier this month about George Webb having a
            location in Appleton years ago, and it turns out, this is that
            location. What a coinky-dink. Go Brew Crew.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            Speaking of our father, I walked out of there with a toothpick
            because I was raised right. Plus, nikkigirl gets a little randy when
        ...
        <section className="space-y-4">
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            ...
            things that get me more excited than the USPS. Ask around, it is
            true. More on this to close the post.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            ...
            cute stamps and a selfie so I could show lulu. Instead, it was
            someone I do not interact with much, and when I tell you she was
            dead inside, I mean she was really dead inside. There was no fun to
            be had. USPS workers are the real MVP - they hate their job
          ...
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            ...
            truck stopped on the street on my way home. I was very excited for
            the help, as per usual. You can see the middle school the little two
            went too behind us. Middle school is for suckers. So says lulu and
            my teacher friends - I do not make up the rules.
          </p>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <figure className="rounded-2xl border border-border/40 bg-white p-2 shadow-sm">
              <Image
        ...
        <section className="space-y-4">
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            Have you ever seen the memes where someone stumbles, trips, and
            falls right into a situation that they definitely did not mean to
            fall into, except of course they did? That was me and Walgreens.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
        ...
        <section className="space-y-4">
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            As I got back to pounding the pavement, I was excited to remember
            that I would be passing the minimum security prison we send the
            teenagers to. What an absolute shithole Appleton West is. Good kids,
            though.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            Lucky for me, eeeeeeeemma got a great parking spot today, and I took
            a little break in front of the prison at their painted rock. It is
        ...
        <section className="space-y-4">
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            Finally, we arrive at the cute stamps. Here is what I came home
            with. I THINK SPONGEBOB STAMPS ARE CUTE.......and lulu does not. She
            chose the baby wild animals. Coming soon to an inbox near you.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
        ...
        <section className="space-y-4">
          ...
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            And then last, but not least, how about we chat about how amazing
            the USPS and TCDb are. My very first trade on TCDb was 2021-02-13.
            Since then, I have completed 2047 trades, 100% through the US Postal
            Service. While there have been a snafu or two, they deliver at a
            percentage that is entirely amazing. They are fantastic and I will
            not hear otherwise. Plus, spend a few hours waiting in line at the
            post office and you will begin to appreciate the absolute mountain
            of bullshit the employees go through with our fellow man. God bless
            the USPS.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            A few more stats before we close - within those 2047 trades was a
            total of 76,214 cards (34,076 sent and 42,138 received). I have
            traded with 49 of the 50 states, including a few military bases that
            count as a state on the site, and 14 different countries - to
            include 794 unique partners. The most trades I have done with one
            individual is 24 with Shin in the San Francisco area. He is one of
            handful of people I have saved as a contact on my phone, and I would
            loosely consider him a friend, if not my best penpal.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
            I have correspondants for the Utah Jazz, Portland Trail Blazers, New
            York Yankees, Seattle Kraken, and on, and on, and on. They all send
            me their Bucks cards, and I love them for it.
          </p>
          <p className="text-[16px] text-muted-foreground md:text-[18px]">
