...
export default function ProductionPageLink({
  ...
  return (
    <a
      ...
      className={cn(
        "inline-flex shrink-0 items-center gap-1.5 rounded-full border border-current/25 px-3 py-1.5 text-xs font-semibold text-ink/70 no-underline transition hover:bg-ink/5 hover:text-ink",
        className,
      )}
