  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "group flex min-h-[48px] items-center gap-3 rounded-2xl border-[0.5px] border-[color:var(--border-subtle,#d1d5db)] bg-[color:var(--surface-card,#f0ebd2)] px-4 py-3 text-base font-medium leading-6 text-[color:var(--text-strong,#0e2240)] transition-colors",
