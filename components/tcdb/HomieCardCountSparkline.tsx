...
type Props = {
  snapshots: HomieTcdbSnapshotRow[];
};

type ChartDatum = HomieTcdbSnapshotRow & {
...
function toChartDatum(row: HomieTcdbSnapshotRow): ChartDatum {
  return {
    ...row,
...
export default function HomieCardCountSparkline({ snapshots }: Props) {
