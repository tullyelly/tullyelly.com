  ...
  return (
    <section aria-label="First Off The Line" className="space-y-2">
      ...
      <figure className="space-y-2">
        <div className="yt-wrapper-bucks yt-wrapper-bucks--vertical">
          <iframe
            src="https://www.youtube-nocookie.com/embed/4zWeI5dDDyY?loop=1&playlist=4zWeI5dDDyY"
            title="YouTube Short"
            loading="lazy"
      ...
      <ul className="list-disc list-inside text-sm md:text-[15px] space-y-1">
        <li>
          ...
          >
            https://github.com/tullyelly/tullyelly.com
          </a>
        </li>
      </ul>
      <p className="text-sm md:text-[15px] text-muted-foreground">
