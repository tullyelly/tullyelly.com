...
<ReleaseSection alterEgo="mark2" releaseId="36">
    ...
    I haven't eaten breakfast yet today, so breadcrumbs are making me hungry right now. <PersonTag tag="nikkigirl" /> is with a friend who I'm saying isn't really a friend.....another one of those later gator stories. I'm hungry, and it's her fault, is the point. lulz
...
<ReleaseSection alterEgo="cardattack">
  PS, I also sorted, logged, and sleeved up 10,000+ cards during the last few
  weeks too. Talk to robot, sort cards, test robot's output, log cards, yell at
  stupid robot, sleeve cards. Rinse hands & repeat.
</ReleaseSection>
...
<ReleaseSection alterEgo="mark2">
    ...
    <FruityLoops loop="vee-two-dot-five/obsidian.webp" alt="Brain Map" />
    <br />
