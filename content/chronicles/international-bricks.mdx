...
<ReleaseSection alterEgo="cardattack" releaseId="55">
    ...
    Anywho, don't tell the <PersonTag displayName="united states postal service" tag="usps" />, but I've taken everything that <PersonTag displayName="clipse" tag="clipse" /> has taught me and I'm steady flippin' bricks across state and international (arbitrary) borders.
