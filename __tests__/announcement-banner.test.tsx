...
test("can be dismissed", () => {
  ...
  render(
    <AnnouncementBanner message="bye" dismissible onDismiss={onDismiss} />,
  );
...
test("variants apply classes", () => {
  const { rerender, container } = render(
    <AnnouncementBanner message="v" variant="info" />,
  );
  ...
  expect(container.firstChild).toHaveClass("bg-[color:var(--bucks-green)]");
