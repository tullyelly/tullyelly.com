-- 057_create_homie_tcdb_ranking_route_view.sql
-- Purpose: Expose homie TCDB rankings with route metadata from dojo.homie.
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'app_user') THEN
    GRANT SELECT ON TABLE dojo.v_homie_tcdb_ranking_route TO app_user;
  END IF;
END
$$;
